...
def check_identity_coherence(normalized_dossier: Dict[str, Any]) -> List[Dict]:
    ...
    if conducteur_a_nom_complet and assure_a and not _names_match(conducteur_a_nom_complet, assure_a):
        anomalies.append({
            ...
            "severity": "mineure",
            "detail": f"Le conducteur declare ('{conducteur_a_nom_complet}') differe de "
    ...
    if cin:
        ...
        if conducteur_a_nom_complet and cin_nom_complet and not _names_match(conducteur_a_nom_complet, cin_nom_complet):
            anomalies.append({
                ...
                "severity": "majeure",
                "detail": f"Le nom du conducteur dans le constat ('{conducteur_a_nom_complet}') "
        ...
        if permis_num_constat and permis_num_carte:
            ...
            if n1 and n2 and n1 != n2:
                anomalies.append({
                    ...
                    "severity": "majeure",
                    "detail": f"Le numero de permis dans le constat ('{permis_num_constat}') "
    ...
    if carte_grise:
        ...
        if immat_constat and immat_carte_grise:
            ...
            if n1 and n2 and n1 != n2:
                anomalies.append({
                    ...
                    "severity": "majeure",
                    "detail": f"L'immatriculation dans le constat ('{immat_constat}') "
        ...
        if assure_a and nom_carte_grise and not _names_match(assure_a, nom_carte_grise):
            anomalies.append({
                ...
                "severity": "mineure",
                "detail": f"Le proprietaire sur la carte grise ('{nom_carte_grise}') differe "
