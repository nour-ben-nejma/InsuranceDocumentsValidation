...
def build_normalized_dossier(documents: Dict[str, Optional[Dict]]) -> Dict[str, Any]:
    ...
    normalized = {
        "constat": {
            ...
            "marque_type_a": _get(constat, "9. Identite du Vehicule", "Vehicule A", "Marque/Type"),
        ...
        "carte_grise": {
            ...
            "type_commercial": _unwrap_value(_get(carte_grise, "type_commercial")),
            "cin_ou_mf": _unwrap_value(_get(carte_grise, "cin_ou_mf")),
